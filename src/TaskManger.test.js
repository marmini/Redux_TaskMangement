...
const TaskManger = rewire("./TaskManger")
const mapStateToProps = TaskManger.__get__("mapStateToProps")
const mapDispatchToProps = TaskManger.__get__("mapDispatchToProps")
// @ponicode
